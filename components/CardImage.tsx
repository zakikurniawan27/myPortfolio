  ...
  return (
    <>
        <div className='flex justify-start sm:justify-center md:justify-center'>
            <div className='w-1/3 sm:w-11/12 md:w-2/3 bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 group relative block overflow-hidden rounded-md transition-all duration-500'>
                <a className=' transition-all duration-500 group-hover:scale-105 tobii-zoom' href='https://challenge-04-todoapp-j10nukeoa-zakikurniawan27.vercel.app/'>
                    <img src={projectku1.src} alt='fotoProject'/>
        ...
        <div className='flex justify-center mt-10'>
            <div className='w-1/3 sm:w-11/12 md:w-2/3 bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 group relative block overflow-hidden rounded-md transition-all duration-500'>
                <a className=' transition-all duration-500 group-hover:scale-105 tobii-zoom' href='https://movielist-app-challenge-07.vercel.app/'>
                    <img src={projectku2.src} alt='fotoProject'/>
